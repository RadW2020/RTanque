...
=begin	print "sensors.position.x e .y: #{sensors.position.x} #{sensors.position.y}\n"
				#print "nearest.position.x e .y: #{nearest.position.x} #{nearest.position.y}\n"
				print "sensors.position.x e .y: #{sensors.position.x} #{sensors.position.y}\n"
